...
_CPE_STR	 = cpe:2.3:${CPE_PART}:${CPE_VENDOR:C/([^-_a-zA-Z0-9])/_ESC_\1/g:S/_ESC_/\\/g}:${CPE_PRODUCT:C/([^-_a-zA-Z0-9])/_ESC_\1/g:S/_ESC_/\\/g}:${CPE_VERSION}:${CPE_UPDATE}:${CPE_EDITION}:${CPE_LANG}:${CPE_SW_EDITION}:${CPE_TARGET_SW}:${CPE_TARGET_HW}:${CPE_OTHER}
CPE_STR		?= ${_CPE_STR:C/:+$//}
_CPE_URI        ?= cpe:/${CPE_PART}:${CPE_VENDOR:C/([^-_a-zA-Z0-9])/_ESC_\1/g:S/_ESC_/\\/g}:${CPE_PRODUCT:C/([^-_a-zA-Z0-9])/_ESC_\1/g:S/_ESC_/\\/g}:${CPE_VERSION}:${CPE_UPDATE:S/*//}:${CPE_EDITION:S/*//}:${CPE_LANG:S/*//}
CPE_URI         ?= ${_CPE_URI:C/:+$//}
